        ...
        <div className={styles.adminLayout}>
            ...
            <aside className={`${styles.sidebar} ${open ? styles.open : ''}`}>
                ...
                <nav className={styles.navMenu} onClick={() => setOpen(false)}>
                    ...
                    <NavLink to="Packages" className={({ isActive }) => isActive ? styles.active : ''}>
                        <Package className={styles.icon} size={20} />
                        <span className={styles.linkText}>الباقات</span>
                    </NavLink>

                    <NavLink to="Subscribers" className={({ isActive }) => isActive ? styles.active : ''}>
                        <Users className={styles.icon} size={20} />
                        <span className={styles.linkText}>المشتركين</span>
                        
                    </NavLink>

                         <NavLink to="SubscriptionRequests" className={({ isActive }) => isActive ? styles.active : ''}>
